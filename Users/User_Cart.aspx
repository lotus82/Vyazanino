<%@ Page Title="" Language="C#" MasterPageFile="~/VyazaninoCOM.Master" AutoEventWireup="true" CodeBehind="User_Cart.aspx.cs" Inherits="VyazaninoCOM.Users.User_Cart" %>
                                        ...
                                        <table class="table" style="padding: 0px 0px 0px 0px; margin: 0px 0px 0px 0px;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="cart-qty item">Кол-во</th>
                                                    <th class="cart-sub-total item">Цена</th>
                                                    <th class="cart-total last-item">Стоимость</th>
                                                </tr>
                                            </thead>
                                                ...
                                                <tr style="border-top: 2px solid grey;padding: 0px 0px 0px 0px; margin: 0px 0px 0px 0px;">
                                                    <td colspan="6" style="padding: 0px 0px 0px 0px; margin: 0px 0px 0px 0px;">
                                                        <div class="shopping-cart-btn" style="padding: 0px 0px 0px 0px; margin: 0px 0px 0px 0px;">
                                                            <span class="">
                                                               <%--<asp:Button ID="Button_Cart_Update" class="btn btn-upper btn-primary outer-left-xs" runat="server" onclick="Button_Cart_Update_Click" Text="Обновить" />--%>
                                                               <asp:Button ID="Button_Cart_Clear" class="btn btn-upper btn-primary pull-right outer-right-xs"  runat="server" OnClick="Button_Cart_Clear_Click" Text="Очистить" /><br/><br/>
                                                            </span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <asp:Repeater ID="Repeater_Cart" runat="server" OnItemCommand="Repeater_Cart_ItemCommand" DataMember="">
                                                    ...
                                                    <ItemTemplate>
                                                        <tr style="padding: 0px 0px 0px 0px; margin: 0px 0px 0px 0px; border-bottom: 1px solid grey;">
                                                            ...
                                                            <asp:HiddenField ID="HiddenField_Seller" runat="server" Value='<%#Eval("ID_Seller")%>' />
                                                                <asp:HiddenField ID="HF_ID_Goods_Cart" runat="server" Value='<%#Eval("ID_Goods")%>' />
                                                            </td>
                                                            <td class="cart-image" style="border:1px solid grey; text-align:center;width:100px;">
                                                            ...
                                                            <td class="cart-product-quantity" style="border:1px solid grey;width:100px;text-align:center;padding: 0px 10px 0px 10px;">
                                                                <asp:TextBox ID="TextBox_Count_Product" Width="60" TextMode="Number"  runat="server" Wrap="False" Text='<%#Eval("Count_Goods_Cart") %>'></asp:TextBox>
                                                            </td>
                                                            ...
                                                            <td class="cart-product-grand-total" style="border:1px solid grey;text-align:center;width:150px;padding: 0px 10px 0px 10px;"><span class="cart-grand-total-price"><%#Eval("Summa_Goods") %></span></td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Button ID="Button_Order_Seller" class="btn btn-upper btn-primary pull-right outer-right-xs" CommandName="Order_Seller" runat="server" Text="Оформить" />
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
                                            ...
                                            <%--<tr style="padding: 0px 0px 0px 0px; margin: 0px 0px 0px 0px;">
                                                <td colspan="2" style="padding: 10px 10px 10px 10px; margin: 0px 0px 0px 0px;">
                                                    <div class="cart-checkout-btn pull-right">
                                                        <asp:Button ID="Button_Order" CssClass="btn btn-primary checkout-btn" OnClick="Button_Order_Click" runat="server" Text="ОФОРМИТЬ" />
                                                    </div>
                                                </td>
                                            </tr>--%>
                                        </tbody>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <div class="modal-content" style="width: 240px; height: 220px;padding:0px 0px 0px 0px;">
                                        <div class="modal-header" style="border-top-left-radius: 10px; color: #0033cc;">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            <center><h4 class="modal-title"><asp:Label ID="Label1" runat="server" Text="Предупреждение" ForeColor="Red" Font-Bold="false"></asp:Label></h4></center>
                                        </div>
                                        <div class="modal-body" style="text-align:center;">
                                                   <asp:Label ID="Label2" runat="server" ForeColor="#157ed2" Text="Удалить товар из корзины?" Font-Bold="false"></asp:Label>
                                            <br /><br />
                                            <div class="row" style="white-space:nowrap;">
                                                <div class="col-sm-6 col-md-6">
